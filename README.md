...
If you built from source and `make install` didn't fix permissions, you can do it manually:
...
-----------------------
 ...
 __Environment-Agnostic Actions__

    do: workspace-left     # switch to the workspace to the left
    do: workspace-right    # switch to the workspace to the right
    do: workspace-up       # switch to the workspace above
